    ...
    fixture.forEach(([financiado, meses, amortizacao]) => {
      it(`deve retornar R$${amortizacao}, quando financiamento for` +
         ...
         () => {
           ...
           sac.amortizacao().should.be.within(amortizacao, amortizacao + 0.1);
         });
    });
  });
    ...
    fixture.forEach(([financiado, meses, jurosMesPerc, parcelasPagas, jurosSobreSaldoDevedor]) => {
      it(`deve retornar R$${jurosSobreSaldoDevedor}, quando financiamento for` +
         ...
         () => {
           ...
           sac.jurosSobreSaldoDevedor(parcelasPagas).should.be.within(
             jurosSobreSaldoDevedor, jurosSobreSaldoDevedor + 0.1);
         });
    });
  });
    ...
    fixture.forEach(([financiado, meses, jurosMesPerc, parcelasPagas, valorParcela]) => {
      ...
      ` ${jurosMesPerc} e parcelas já pagas for ${parcelasPagas}`,
         () => {
           ...
           sac.valorParcela(parcelasPagas).should.be.within(valorParcela, valorParcela + 0.1);
         });
    });
  });
  ...
  describe('#tabela', () => {
    it('deve retornar uma tabela com 20 parcelas', () => {
      ...
      const esperado: Financiamento[] = [
        {
          n:'1',	parcela: '6320.60',	amortizacao: '5525.00',
          juros: '795.60',	devedor: '104975.00',
        },
        {
          n:'2',	parcela: '6280.82',	amortizacao: '5525.00',
          juros: '755.82',	devedor: '99450.00',
        },
        {
          n:'3',	parcela: '6241.04',	amortizacao: '5525.00',
          juros: '716.04',	devedor: '93925.00',
        },
        {
          n:'4',	parcela: '6201.26',	amortizacao: '5525.00',
          juros: '676.26',	devedor: '88400.00',
        },
        {
          n:'5',	parcela: '6161.48',	amortizacao: '5525.00',
          juros: '636.48',	devedor: '82875.00',
        },
        {
          n:'6',	parcela: '6121.70',	amortizacao: '5525.00',
          juros: '596.70',	devedor: '77350.00',
        },
        {
          n:'7',	parcela: '6081.92',	amortizacao: '5525.00',
          juros: '556.92',	devedor: '71825.00',
        },
        {
          n:'8',	parcela: '6042.14',	amortizacao: '5525.00',
          juros: '517.14',	devedor: '66300.00',
        },
        {
          n:'9',	parcela: '6002.36',	amortizacao: '5525.00',
          juros: '477.36',	devedor: '60775.00',
        },
        {
          n:'10',	parcela: '5962.58',	amortizacao: '5525.00',
          juros: '437.58',	devedor: '55250.00',
        },
        {
          n:'11',	parcela: '5922.80',	amortizacao: '5525.00',
          juros: '397.80',	devedor: '49725.00',
        },
        {
          n:'12',	parcela: '5883.02',	amortizacao: '5525.00',
          juros: '358.02',	devedor: '44200.00',
        },
        {
          n:'13',	parcela: '5843.24',	amortizacao: '5525.00',
          juros: '318.24',	devedor: '38675.00',
        },
        {
          n:'14',	parcela: '5803.46',	amortizacao: '5525.00',
          juros: '278.46',	devedor: '33150.00',
        },
        {
